...
export interface paths {
    "/api/v1/sample/doc": {
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "text/plain": components["schemas"]["ResultOfIReadOnlyListOfSampleDoc"];
                        "application/json": components["schemas"]["ResultOfIReadOnlyListOfSampleDoc"];
                        "text/json": components["schemas"]["ResultOfIReadOnlyListOfSampleDoc"];
                    };
                };
            };
        };
        ...
        post: {
            ...
            requestBody: {
                content: {
                    "application/json": components["schemas"]["SampleDocInput"];
                    "text/json": components["schemas"]["SampleDocInput"];
                    "application/*+json": components["schemas"]["SampleDocInput"];
                };
            };
            responses: {
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "text/plain": components["schemas"]["ResultOfPagedListOfCustomer"];
                        "application/json": components["schemas"]["ResultOfPagedListOfCustomer"];
                        "text/json": components["schemas"]["ResultOfPagedListOfCustomer"];
                    };
                };
            };
        };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "text/plain": components["schemas"]["ResultOfCustomer"];
                        "application/json": components["schemas"]["ResultOfCustomer"];
                        "text/json": components["schemas"]["ResultOfCustomer"];
                    };
                };
            };
        };
        put: {
            ...
            requestBody: {
                content: {
                    ...
                    "text/json": components["schemas"]["CustomerInput"];
                    "application/*+json": components["schemas"]["CustomerInput"];
                };
            };
            responses: {
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "text/plain": components["schemas"]["ResultOfCustomerScopeDto"];
                        "application/json": components["schemas"]["ResultOfCustomerScopeDto"];
                        "text/json": components["schemas"]["ResultOfCustomerScopeDto"];
                    };
                };
            };
        };
...
export interface components {
    schemas: {
        ...
        CustomerScopeDto: {
            kind: components["schemas"]["CustomerScopeKind"];
            orgName?: null | string;
            /** Format: int32 */
            visibleOrgCount?: number | string;
            includeSelf?: boolean;
        };
        CustomerScopeKind: number;
        ...
        ResultOfCustomer: {
            ...
            /** @description 兜底文案(仅降级用途,浏览器端一律走 MsgKey 翻译) */
            message?: null | string;
            data?: null | components["schemas"]["Customer"];
        };
        /**
         * @description 统一返回模型(设计 §6/§13.2)——所有接口的响应外壳。
         *     字段分工:Code 给机器判断;MsgKey+Args 给前端 i18n 渲染;
        ...
        ResultOfCustomerScopeDto: {
            ...
            /** @description 兜底文案(仅降级用途,浏览器端一律走 MsgKey 翻译) */
            message?: null | string;
            data?: null | components["schemas"]["CustomerScopeDto"];
        };
        /**
         * @description 统一返回模型(设计 §6/§13.2)——所有接口的响应外壳。
         *     字段分工:Code 给机器判断;MsgKey+Args 给前端 i18n 渲染;
         ...
         *     失败:`{ "code": 40001, "msgKey": "error.auth.passwordWrong", "args": {}, "message": "...", "data": null }`</example>
         */
        ResultOfIReadOnlyListOfSampleDoc: {
            /**
             * Format: int32
             * @description 业务码,0 为成功,其余见 ErrorCode 分段
             */
            ...
            message?: null | string;
            /** @description 业务数据载荷 */
            data?: null | components["schemas"]["SampleDoc"][];
        };
        /**
         * @description 统一返回模型(设计 §6/§13.2)——所有接口的响应外壳。
         *     字段分工:Code 给机器判断;MsgKey+Args 给前端 i18n 渲染;
        ...
        ResultOfPagedListOfCustomer: {
            ...
            /** @description 兜底文案(仅降级用途,浏览器端一律走 MsgKey 翻译) */
            message?: null | string;
            data?: null | components["schemas"]["PagedListOfCustomer"];
        };
        /**
         * @description 统一返回模型(设计 §6/§13.2)——所有接口的响应外壳。
         *     字段分工:Code 给机器判断;MsgKey+Args 给前端 i18n 渲染;
